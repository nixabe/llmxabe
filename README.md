...
>
> Measured against llama.cpp on the same card: prefill **~1,644 tok/s**
> at 512 tokens against 2,070.50 (**1.26× slower**), decode **104.4–105.8
...
| --- | ---: | ---: | --- |
| Prefill, 512 tokens | 2,070.50 ± 160.35 tok/s | **1,644**, 1,639–1,655 | 1.26× slower |
| Decode, warm | 104.72 ± 0.36 tok/s | **104.4–105.8** (thermal) | level |

Prefill was 29.6× slower, then 10.3×, and is now 1.26× — **still a loss**, and
